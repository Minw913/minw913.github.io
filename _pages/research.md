...
<div class="content-wrapper" style="display: flex; max-height: 500px; align-items: flex-start;">
  <div id="researchCarousel" class="carousel slide" data-ride="carousel" style="flex-basis: 50%; background-color: #0f1117; height: 100%; justify-content: center; align-items: center;">
