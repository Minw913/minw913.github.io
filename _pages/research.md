...
<p style="margin-top: 30px; margin-bottom: 0;">Preprint forthcoming on arXiv (<a href="/files/research_1/Sample_of_work.pdf" target="_blank"><i class="fas fa-file-pdf"></i> Sample of Work</a>). Code available on <a href="https://github.com/your-repo-link" target="_blank"><i class="fab fa-github"></i> GitHub</a>.</p>
<!-- 分隔线 -->
